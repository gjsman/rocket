    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                    ...
                    <div class="ml-3 relative">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link href="{{ url('/subscription') }}">
                                    {{ __('Subscription') }}
                                </x-dropdown-link>
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-emerald-100 hover:text-emerald-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition">
        ...
        <div class="pt-4 pb-1 border-t border-emerald-500">
            @if(\Illuminate\Support\Facades\Auth::check())
                <div class="flex items-center px-4">
                    ...
                    <div>
                        <div class="font-medium text-base text-emerald-100">{{ Auth::user()->name }}</div>
                        <div class="font-medium text-sm text-emerald-300">{{ Auth::user()->email }}</div>
                    </div>
                </div>

                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link href="{{ route('students.manage') }}" :active="request()->routeIs('students.manage')">
                        {{ __('Students') }}
                    </x-responsive-nav-link>
                    ...
                    <x-responsive-nav-link href="{{ url('/subscription') }}">
                        {{ __('Subscription') }}
                    </x-responsive-nav-link>
