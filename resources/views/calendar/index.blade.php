            ...
            <div class="mt-10 text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 lg:mt-9 xl:col-start-9">
                ...
                <div class="isolate mt-2 grid grid-cols-7 gap-px rounded-lg bg-gray-200 text-sm shadow ring-1 ring-gray-200">
                    <!--
                      ...
                      Is today and is not selected, include: "text-green-600"
                    ...
                    <button type="button" class="rounded-tl-lg bg-gray-50 py-1.5 text-gray-400 hover:bg-gray-100 focus:z-10">
                        <!--
                          ...
                          Is selected and is today, include: "bg-green-600"
                    ...
                    <button type="button" class="bg-white py-1.5 font-semibold text-green-600 hover:bg-gray-100 focus:z-10">
                ...
                <button type="button" class="focus:outline-none mt-8 w-full rounded-md border border-transparent bg-green-600 py-2 px-4 text-sm font-medium text-white shadow hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Add event</button>
            </div>
